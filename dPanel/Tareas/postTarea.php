<?php
    ...
    function postTarea($titulo,$contenido,$fechaI,$fechaF,$grupo,$materia)
    {
        ...
        $sql ="INSERT INTO tbl_tareas(titulo_tarea,descripcion_tarea,fecha_creacion,fecha_entrega,id_grupo,id_materia,id_docente,existe) VALUES('{$titulo}','{$contenido}','{$fechaI}','{$fechaF}',$grupo,$materia,".$_SESSION['IDUSER'].",1)";
