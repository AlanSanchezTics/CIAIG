<?php 
	...
	$sql = "SELECT ID_AVISO, TITULO_AVISO, DESCRIPCION_AVISO, FECHA_INICIAL, FECHA_FINAL FROM tbl_avisos_alumno WHERE ID_ALUMNO='{$idAlumno}' AND EXISTE = 1 ORDER BY ID_AVISO DESC";
