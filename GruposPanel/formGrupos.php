...
<body>
	<div class="section-header">
        <h2 class="wow fadeInDown animated title">Registro de Grupo</h2>
    </div>
	<div style="width: 100%; margin-left: 25%; margin-top: 20pt;">
		<form action="nuevo_prod2.php" method="POST" enctype="multipart/form-data" name="form1" onsubmit="return verifyCombos()">
			<div class="col-6">
                    <?php 
                        if(isset($_GET['ref'])){
			...
			<div class="form-row">
                <div class="col-3">
                    <button type="submit" id="submit" name="send" class="btn btn-primary btn-lg btn-block" style="border-radius: 5pt; margin-top: 20px;">Registrar Grupo</button>
                </div>
                <div class="col-3">
