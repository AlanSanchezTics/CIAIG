<?php
    ...
    $sql = "SELECT NOMBRE, A_PATERNO, A_MATERNO, TEL, EMAIL FROM tbl_administradores WHERE ID_ADMIN='{$_GET['no']}'";
...
<body>
    <div class="section-header">
        <h2 class="wow fadeInDown animated title">Modifcación de Administrador</h2>
    </div>
    ...
    <input type="hidden" name="id_admin" value="<?php echo $_GET['no'] ?>">
        <div class="col-6">
            <?php 
                if(isset($_GET['ref'])){
                    if($_GET['ref']==='1'){
                        echo "<div class='alert alert-danger' role='alert'  align='center'>Administrador ya registrado!!</div>";
                        
                    }else if($_GET['ref']==='success'){
                        echo "<div class='alert alert-success' role='alert' align='center'>Administrador registrado correctamente!!</div>";
                    }
                }
            ?>
        </div>
        <div class="form-row">
            ...
            <div class="col-2">
                ...
                <input type="text" class="form-control" name="amaterno" value="<?php echo $reg[2] ?>" required id="amaterno" placeholder="Apellido Materno">
            </div>
        </div>
        <div class="form-row">
            <div class="col-3">
