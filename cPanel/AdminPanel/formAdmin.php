...
<body>
    <div class="section-header">
        <h2 class="wow fadeInDown animated title">Registro de Administrador</h2>
    </div>
    ...
    <form action="nuevo_prod2.php" method="POST" enctype="multipart/form-data" id="formulario"  onsubmit=" return verify();">
        ...
        <div class="form-row">
                <div class="col-3">
                    <button type="submit" id="submit" name="send" class="btn btn-primary btn-lg btn-block" style="border-radius: 5pt; margin-top: 20px;">Registrar Administrador</button>
                </div>
                <div class="col-3">
