...
if (isset($_GET["ref"])) {
    if ($_GET["ref"] == "del") {
        ...
        if ($_POST["tipoAviso"] == "general") {
            avisos_generales($_POST["idAviso"], $_POST["titulo"], $_POST["asunto"], $_POST["fechaI"], $_POST["fechaF"], $_SESSION['IDUSER']);
        } elseif ($_POST["tipoAviso"] == "grupo") {
            avisos_grupo($_POST["idAviso"], $_POST["titulo"], $_POST["asunto"], $_POST["fechaI"], $_POST["fechaF"], $_SESSION['IDUSER'], $_POST["grupo"]);
        } elseif ($_POST["tipoAviso"] == "nivel") {
            avisos_nivel($_POST["idAviso"], $_POST["titulo"], $_POST["asunto"], $_POST["fechaI"], $_POST["fechaF"], $_SESSION['IDUSER'], $_POST["nivel"]);
        } elseif ($_POST["tipoAviso"] == "alumno") {
            avisos_alumno($_POST["idAviso"], $_POST["titulo"], $_POST["asunto"], $_POST["fechaI"], $_POST["fechaF"], $_SESSION['IDUSER'], $_POST["alumno"]);
        }
    }
}
...
function reenviarAviso($idaviso, $tipo)
{
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $message = array('Message' => " La institucion acaba de publicar un aviso, Veelo ahora!!", 'Title' => $reg[1], 'body' => $reg[2], 'FechaI' => $reg[3], 'FechaF' => $reg[4]);
