<?php
    session_start();
    if($_POST["tipoAviso"]=="general"){avisos_generales($_POST["titulo"],$_POST["asunto"],$_POST["fechaI"],$_POST["fechaF"], $_SESSION['IDUSER']);}
    elseif ($_POST["tipoAviso"]=="grupo") {avisos_grupo($_POST["titulo"],$_POST["asunto"],$_POST["fechaI"],$_POST["fechaF"], $_SESSION['IDUSER'],$_POST["grupo"]);}
    elseif($_POST["tipoAviso"]=="nivel"){avisos_nivel($_POST["titulo"],$_POST["asunto"],$_POST["fechaI"],$_POST["fechaF"],$_SESSION['IDUSER'],$_POST["nivel"]);}
    elseif($_POST["tipoAviso"]=="alumno"){avisos_alumno($_POST["titulo"],$_POST["asunto"],$_POST["fechaI"],$_POST["fechaF"],$_SESSION['IDUSER'],$_POST["alumno"]);}
