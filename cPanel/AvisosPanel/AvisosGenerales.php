<?php 
	...
	$sql = "SELECT ID_AVISO, TITULO_AVISO, DESCRIPCION_AVISO, FECHA_INICIAL, FECHA_FINAL FROM tbl_avisosgenerales WHERE EXISTE = 1 AND FECHA_FINAL > NOW() ORDER BY ID_AVISO DESC";
