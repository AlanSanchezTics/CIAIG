<?php 
    ...
    $sqlgenerales="SELECT ID_AVISO, TITULO_AVISO, DESCRIPCION_AVISO, FECHA_INICIAL, FECHA_FINAL, tbl_administradores.NOMBRE FROM tbl_avisosgenerales,tbl_administradores WHERE tbl_avisosgenerales.ID_ADMIN = tbl_administradores.ID_ADMIN AND tbl_avisosgenerales.EXISTE=1 ORDER BY ID_AVISO DESC";
    $sqlnivel ="SELECT ID_AVISO, TITULO_AVISO, DESCRIPCION_AVISO, FECHA_INICIAL, FECHA_FINAL,tbl_administradores.NOMBRE, NIVEL FROM tbl_avisos_nivel, tbl_administradores WHERE tbl_avisos_nivel.ID_ADMIN = tbl_administradores.ID_ADMIN AND tbl_avisos_nivel.EXISTE=1 ORDER BY ID_AVISO DESC";
    ...
    $sqlalumno="SELECT ID_AVISO, TITULO_AVISO, DESCRIPCION_AVISO, FECHA_INICIAL, FECHA_FINAL,tbl_administradores.NOMBRE, tbl_alumnos.NOMBRE,tbl_alumnos.A_PATERNO FROM tbl_avisos_alumno, tbl_administradores,tbl_alumnos WHERE tbl_avisos_alumno.ID_ADMIN = tbl_administradores.ID_ADMIN AND tbl_avisos_alumno.ID_ALUMNO= tbl_alumnos.ID_ALUMNO AND tbl_avisos_alumno.EXISTE=1  ORDER BY ID_AVISO DESC";
