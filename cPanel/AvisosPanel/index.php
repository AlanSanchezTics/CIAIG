<?php 
    ...
    $sqlgenerales="SELECT ID_AVISO, TITULO_AVISO, DESCRIPCION_AVISO, FECHA_INICIAL, FECHA_FINAL, tbl_administradores.NOMBRE FROM tbl_avisosgenerales,tbl_administradores WHERE tbl_avisosgenerales.ID_ADMIN = tbl_administradores.ID_ADMIN AND tbl_avisosgenerales.EXISTE=1 AND FECHA_FINAL > NOW() ORDER BY ID_AVISO DESC";
    $sqlnivel ="SELECT ID_AVISO, TITULO_AVISO, DESCRIPCION_AVISO, FECHA_INICIAL, FECHA_FINAL,tbl_administradores.NOMBRE, NIVEL FROM tbl_avisos_nivel, tbl_administradores WHERE tbl_avisos_nivel.ID_ADMIN = tbl_administradores.ID_ADMIN AND tbl_avisos_nivel.EXISTE=1 AND FECHA_FINAL > NOW() ORDER BY ID_AVISO DESC";
    $sqlgrupo="SELECT ID_AVISO, TITULO_AVISO, DESCRIPCION_AVISO, FECHA_INICIAL, FECHA_FINAL,tbl_administradores.NOMBRE, tbl_grupos.GRADO, tbl_grupos.NOMBRE, tbl_grupos.NIVEL FROM tbl_avisos_grupo, tbl_administradores,tbl_grupos WHERE tbl_avisos_grupo.ID_ADMIN = tbl_administradores.ID_ADMIN AND tbl_avisos_grupo.ID_GRUPO = tbl_grupos.ID_GRUPO AND tbl_avisos_grupo.EXISTE=1 AND FECHA_FINAL > NOW() ORDER BY ID_AVISO DESC";
    $sqlalumno="SELECT ID_AVISO, TITULO_AVISO, DESCRIPCION_AVISO, FECHA_INICIAL, FECHA_FINAL,tbl_administradores.NOMBRE, tbl_alumnos.NOMBRE,tbl_alumnos.A_PATERNO FROM tbl_avisos_alumno, tbl_administradores,tbl_alumnos WHERE tbl_avisos_alumno.ID_ADMIN = tbl_administradores.ID_ADMIN AND tbl_avisos_alumno.ID_ALUMNO= tbl_alumnos.ID_ALUMNO AND tbl_avisos_alumno.EXISTE=1 AND FECHA_FINAL > NOW() ORDER BY ID_AVISO DESC";
                    ...
                    <?php 
                        while ($reg = mysqli_fetch_array($resultg)){
                            echo '  <tr>
                                        ...
                                        <td><a href="mod_prod2.php?id='.$reg[0].'&ref=resend&type=1"><button type="button" class="btn btn-primary btn-sm" data-toggle="tooltip" title="Reenviar Aviso"><img src="./icons/resend.png" width="16px" heigth="16px"></button></a> <a href="modAviso.php?id='.$reg[0].'&type=1"><button type="button" class="btn btn-warning btn-sm" data-toggle="tooltip"  title="Modificar Aviso"><img src="./icons/Edit.png" width="16px" heigth="16px"></button></a> <button type="button" class="btn btn-danger btn-sm" onclick="eliminar(';echo "$reg[0], '{$reg[1]}'";echo ',1)" data-toggle="tooltip"  title="Eliminar Aviso"><img src="./icons/delete.png" width="16px" heigth="16px"></button></td>
                                    </tr>';
                        }
                    ?>
                </tbody>
                    ...
                    <?php 
                        while ($reg = mysqli_fetch_array($resultn)){
                            echo '  <tr>
                                        ...
                                        <td><a href="mod_prod2.php?id='.$reg[0].'&ref=resend&type=2"><button type="button" class="btn btn-primary btn-sm" data-toggle="tooltip" title="Reenviar Aviso"><img src="./icons/resend.png" width="16px" heigth="16px"></button></a> <a href="modAviso.php?id='.$reg[0].'&type=2" ><button type="button" class="btn btn-warning btn-sm" data-toggle="tooltip"  title="Modificar Aviso"><img src="./icons/Edit.png" width="16px" heigth="16px"></button></a> <button type="button" class="btn btn-danger btn-sm" onclick="eliminar(';echo "$reg[0], '{$reg[1]}'";echo ',2)" data-toggle="tooltip"  title="Eliminar Aviso"><img src="./icons/delete.png" width="16px" heigth="16px"></button></td>
                                    </tr>';
                        }
                    ?>
                </tbody>
                    ...
                    <?php 
                        while ($reg = mysqli_fetch_array($resultal)){
                            echo '  <tr>
                                        ...
                                        <td>'.$reg[6].' '.$reg[7].'</td>
                                        <td>'.date_format(date_create($reg[4]),"d/M/Y").'</td>
                                        <td><a href="mod_prod2.php?id='.$reg[0].'&ref=resend&type=4"><button type="button" class="btn btn-primary btn-sm" data-toggle="tooltip" title="Reenviar Aviso"><img src="./icons/resend.png" width="16px" heigth="16px"></button></a> <a href="modAviso.php?id='.$reg[0].'&type=4" ><button type="button" class="btn btn-warning btn-sm" data-toggle="tooltip"  title="Modificar Aviso"><img src="./icons/Edit.png" width="16px" heigth="16px"></button></a> <button type="button" class="btn btn-danger btn-sm" onclick="eliminar(';echo "$reg[0], '{$reg[1]}'";echo ',4)" data-toggle="tooltip"  title="Eliminar Aviso"><img src="./icons/delete.png" width="16px" heigth="16px"></button>   
                                        </td>
                                    </tr>';
                        }
                    ?>
