        ...
        <div class="form-row">
            ...
            <div class="col-6">
                    <?php 
                        if(isset($_GET['ref'])){
                            ...
                            }else if($_GET['ref']==='successAlumn'){
                                echo "<div class='alert alert-success' role='alert' align='center'>Alumno registrado correctamente!!</div>";
            ...
            <div class="form-row">
                <div class="col-6">
                    ...
                    <input type="text" name="idalumn" id="idalumn" placeholder="No. de control" class="form-control" required>
                </div>
            </div>
            <div class="form-row">
                <div>
            ...
            <div class="form-row">
                <div class="col-3">
                    <button type="submit" id="submit" name="send" class="btn btn-primary btn-lg btn-block" style="border-radius: 5pt; margin-top: 20px;">Registrar Alumno</button>
                </div>
                <div class="col-3">
