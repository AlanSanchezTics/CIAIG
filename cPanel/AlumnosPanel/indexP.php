...
$sql7 = "SELECT tbl_alumnos.ID_ALUMNO,tbl_alumnos.NOMBRE, tbl_alumnos.A_PATERNO, tbl_alumnos.A_MATERNO, tbl_alumnos.TEL, tbl_alumnos.EMAIL, tbl_usuarios.LOGIN, tbl_usuarios.ID_USUARIO FROM `tbl_asignaciongrupos`,tbl_alumnos,tbl_grupos, tbl_usuarios WHERE tbl_alumnos.ID_USUARIO=tbl_usuarios.ID_USUARIO AND tbl_asignaciongrupos.ID_GRUPO = tbl_grupos.ID_GRUPO AND tbl_asignaciongrupos.ID_ALUMNO = tbl_alumnos.ID_ALUMNO AND tbl_grupos.NIVEL=2 AND tbl_grupos.GRADO = 1 AND tbl_grupos.NOMBRE='B' AND tbl_alumnos.EXISTE =1 ORDER BY tbl_alumnos.A_PATERNO";
...
$sql8 = "SELECT tbl_alumnos.ID_ALUMNO,tbl_alumnos.NOMBRE, tbl_alumnos.A_PATERNO, tbl_alumnos.A_MATERNO, tbl_alumnos.TEL, tbl_alumnos.EMAIL, tbl_usuarios.LOGIN, tbl_usuarios.ID_USUARIO FROM `tbl_asignaciongrupos`,tbl_alumnos,tbl_grupos, tbl_usuarios WHERE tbl_alumnos.ID_USUARIO=tbl_usuarios.ID_USUARIO AND tbl_asignaciongrupos.ID_GRUPO = tbl_grupos.ID_GRUPO AND tbl_asignaciongrupos.ID_ALUMNO = tbl_alumnos.ID_ALUMNO AND tbl_grupos.NIVEL=2 AND tbl_grupos.GRADO = 2 AND tbl_grupos.NOMBRE='B' AND tbl_alumnos.EXISTE =1 ORDER BY tbl_alumnos.A_PATERNO";
...
$sql9 = "SELECT tbl_alumnos.ID_ALUMNO,tbl_alumnos.NOMBRE, tbl_alumnos.A_PATERNO, tbl_alumnos.A_MATERNO, tbl_alumnos.TEL, tbl_alumnos.EMAIL, tbl_usuarios.LOGIN, tbl_usuarios.ID_USUARIO FROM `tbl_asignaciongrupos`,tbl_alumnos,tbl_grupos, tbl_usuarios WHERE tbl_alumnos.ID_USUARIO=tbl_usuarios.ID_USUARIO AND tbl_asignaciongrupos.ID_GRUPO = tbl_grupos.ID_GRUPO AND tbl_asignaciongrupos.ID_ALUMNO = tbl_alumnos.ID_ALUMNO AND tbl_grupos.NIVEL=2 AND tbl_grupos.GRADO = 3 AND tbl_grupos.NOMBRE='B' AND tbl_alumnos.EXISTE =1 ORDER BY tbl_alumnos.A_PATERNO";
...
$sql10 = "SELECT tbl_alumnos.ID_ALUMNO,tbl_alumnos.NOMBRE, tbl_alumnos.A_PATERNO, tbl_alumnos.A_MATERNO, tbl_alumnos.TEL, tbl_alumnos.EMAIL, tbl_usuarios.LOGIN, tbl_usuarios.ID_USUARIO FROM `tbl_asignaciongrupos`,tbl_alumnos,tbl_grupos, tbl_usuarios WHERE tbl_alumnos.ID_USUARIO=tbl_usuarios.ID_USUARIO AND tbl_asignaciongrupos.ID_GRUPO = tbl_grupos.ID_GRUPO AND tbl_asignaciongrupos.ID_ALUMNO = tbl_alumnos.ID_ALUMNO AND tbl_grupos.NIVEL=2 AND tbl_grupos.GRADO = 4 AND tbl_grupos.NOMBRE='B' AND tbl_alumnos.EXISTE =1 ORDER BY tbl_alumnos.A_PATERNO";
...
$sql11 = "SELECT tbl_alumnos.ID_ALUMNO,tbl_alumnos.NOMBRE, tbl_alumnos.A_PATERNO, tbl_alumnos.A_MATERNO, tbl_alumnos.TEL, tbl_alumnos.EMAIL, tbl_usuarios.LOGIN, tbl_usuarios.ID_USUARIO FROM `tbl_asignaciongrupos`,tbl_alumnos,tbl_grupos, tbl_usuarios WHERE tbl_alumnos.ID_USUARIO=tbl_usuarios.ID_USUARIO AND tbl_asignaciongrupos.ID_GRUPO = tbl_grupos.ID_GRUPO AND tbl_asignaciongrupos.ID_ALUMNO = tbl_alumnos.ID_ALUMNO AND tbl_grupos.NIVEL=2 AND tbl_grupos.GRADO = 5 AND tbl_grupos.NOMBRE='B' AND tbl_alumnos.EXISTE =1 ORDER BY tbl_alumnos.A_PATERNO";
...
$sql12 = "SELECT tbl_alumnos.ID_ALUMNO,tbl_alumnos.NOMBRE, tbl_alumnos.A_PATERNO, tbl_alumnos.A_MATERNO, tbl_alumnos.TEL, tbl_alumnos.EMAIL, tbl_usuarios.LOGIN, tbl_usuarios.ID_USUARIO FROM `tbl_asignaciongrupos`,tbl_alumnos,tbl_grupos, tbl_usuarios WHERE tbl_alumnos.ID_USUARIO=tbl_usuarios.ID_USUARIO AND tbl_asignaciongrupos.ID_GRUPO = tbl_grupos.ID_GRUPO AND tbl_asignaciongrupos.ID_ALUMNO = tbl_alumnos.ID_ALUMNO AND tbl_grupos.NIVEL=2 AND tbl_grupos.GRADO = 6 AND tbl_grupos.NOMBRE='B' AND tbl_alumnos.EXISTE =1 ORDER BY tbl_alumnos.A_PATERNO";
...
<body>
    ...
    <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
              ...
              <a class="nav-item nav-link" id="nav-7-tab" data-toggle="tab" href="#nav-7" role="tab" aria-controls="nav-7" aria-selected="true">1°B</a>
              <a class="nav-item nav-link" id="nav-2-tab" data-toggle="tab" href="#nav-2" role="tab" aria-controls="nav-2" aria-selected="false">2°A</a>
              <a class="nav-item nav-link" id="nav-8-tab" data-toggle="tab" href="#nav-8" role="tab" aria-controls="nav-8" aria-selected="true">2°B</a>
              <a class="nav-item nav-link" id="nav-3-tab" data-toggle="tab" href="#nav-3" role="tab" aria-controls="nav-3" aria-selected="false">3°A</a>
              <a class="nav-item nav-link" id="nav-9-tab" data-toggle="tab" href="#nav-9" role="tab" aria-controls="nav-9" aria-selected="true">3°B</a>
              <a class="nav-item nav-link" id="nav-4-tab" data-toggle="tab" href="#nav-4" role="tab" aria-controls="nav-4" aria-selected="false">4°A</a>
              <a class="nav-item nav-link" id="nav-10-tab" data-toggle="tab" href="#nav-10" role="tab" aria-controls="nav-10" aria-selected="true">4°B</a>
              <a class="nav-item nav-link" id="nav-5-tab" data-toggle="tab" href="#nav-5" role="tab" aria-controls="nav-5" aria-selected="false">5°A</a>
              <a class="nav-item nav-link" id="nav-11-tab" data-toggle="tab" href="#nav-11" role="tab" aria-controls="nav-11" aria-selected="true">5°B</a>
              <a class="nav-item nav-link" id="nav-6-tab" data-toggle="tab" href="#nav-6" role="tab" aria-controls="nav-6" aria-selected="false">6°A</a>
              <a class="nav-item nav-link" id="nav-12-tab" data-toggle="tab" href="#nav-12" role="tab" aria-controls="nav-12" aria-selected="true">6°B</a>
            </div>
          </nav>
          <div class="tab-content" id="nav-tabContent">
            ...
            <div class="tab-pane fade" id="nav-7" role="tabpanel" aria-labelledby="nav-7-tab">
                <table class="table table-striped">
                    <thead>
                        <tr>
                            <?php 
                            $sqldoce = "SELECT tbl_docentes.NOMBRE, tbl_docentes.A_PATERNO, tbl_docentes.A_MATERNO FROM `tbl_grupos`,tbl_docentes WHERE tbl_grupos.ID_DOCENTE_E = tbl_docentes.ID_DOCENTE AND NIVEL=2 AND GRADO= 1 AND tbl_grupos.NOMBRE='B'";
                            $sqldoci = "SELECT tbl_docentes.NOMBRE, tbl_docentes.A_PATERNO, tbl_docentes.A_MATERNO FROM `tbl_grupos`,tbl_docentes WHERE tbl_grupos.ID_DOCENTE_I = tbl_docentes.ID_DOCENTE AND NIVEL=2 AND GRADO= 1 AND tbl_grupos.NOMBRE='B'";
                            $resultdoce = mysqli_query($conexion, $sqldoce);
                            $resultdoci = mysqli_query($conexion, $sqldoci);
                            if ($reg = mysqli_fetch_array($resultdoce)) {
                                echo "<th colspan=4><span>Maestro: $reg[0] $reg[1] $reg[2]</span></th>";
                    ...
                    <tbody>
                            <?php 
                            while ($reg = mysqli_fetch_array($result7)) {
                                echo '  <tr>
                                <th scope="row">';
                                echo $reg[0];
                                echo '</th>
            ...
            <div class="tab-pane fade" id="nav-8" role="tabpanel" aria-labelledby="nav-8-tab">
                <table class="table table-striped">
                    <thead>
                        <tr>
                            <?php 
                            $sqldoce = "SELECT tbl_docentes.NOMBRE, tbl_docentes.A_PATERNO, tbl_docentes.A_MATERNO FROM `tbl_grupos`,tbl_docentes WHERE tbl_grupos.ID_DOCENTE_E = tbl_docentes.ID_DOCENTE AND NIVEL=2 AND GRADO=2 AND tbl_grupos.NOMBRE='B'";
                            $sqldoci = "SELECT tbl_docentes.NOMBRE, tbl_docentes.A_PATERNO, tbl_docentes.A_MATERNO FROM `tbl_grupos`,tbl_docentes WHERE tbl_grupos.ID_DOCENTE_I = tbl_docentes.ID_DOCENTE AND NIVEL=2 AND GRADO=2 AND tbl_grupos.NOMBRE='B'";
                            $resultdoce = mysqli_query($conexion, $sqldoce);
                            $resultdoci = mysqli_query($conexion, $sqldoci);
                            if ($reg = mysqli_fetch_array($resultdoce)) {
                                echo "<th colspan=4><span>Maestro: $reg[0] $reg[1] $reg[2]</span></th>";
                    ...
                    <tbody>
                            <?php 
                            while ($reg = mysqli_fetch_array($result8)) {
                                echo '  <tr>
                                <th scope="row">';
                                echo $reg[0];
                                echo '</th>
            ...
            <div class="tab-pane fade" id="nav-9" role="tabpanel" aria-labelledby="nav-9-tab">
                <table class="table table-striped">
                    <thead>
                        <tr>
                            <?php 
                            $sqldoce = "SELECT tbl_docentes.NOMBRE, tbl_docentes.A_PATERNO, tbl_docentes.A_MATERNO FROM `tbl_grupos`,tbl_docentes WHERE tbl_grupos.ID_DOCENTE_E = tbl_docentes.ID_DOCENTE AND NIVEL=2 AND GRADO= 3 AND tbl_grupos.NOMBRE='B'";
                            $sqldoci = "SELECT tbl_docentes.NOMBRE, tbl_docentes.A_PATERNO, tbl_docentes.A_MATERNO FROM `tbl_grupos`,tbl_docentes WHERE tbl_grupos.ID_DOCENTE_I = tbl_docentes.ID_DOCENTE AND NIVEL=2 AND GRADO= 3 AND tbl_grupos.NOMBRE='B'";
                            $resultdoce = mysqli_query($conexion, $sqldoce);
                            $resultdoci = mysqli_query($conexion, $sqldoci);
                            if ($reg = mysqli_fetch_array($resultdoce)) {
                                echo "<th colspan=4><span>Maestro: $reg[0] $reg[1] $reg[2]</span></th>";
                    ...
                    <tbody>
                            <?php 
                            while ($reg = mysqli_fetch_array($result9)) {
                                echo '  <tr>
                                <th scope="row">';
                                echo $reg[0];
                                echo '</th>
            ...
            <div class="tab-pane fade" id="nav-10" role="tabpanel" aria-labelledby="nav-10-tab">
                <table class="table table-striped">
                    <thead>
                        <tr>
                            <?php 
                            $sqldoce = "SELECT tbl_docentes.NOMBRE, tbl_docentes.A_PATERNO, tbl_docentes.A_MATERNO FROM `tbl_grupos`,tbl_docentes WHERE tbl_grupos.ID_DOCENTE_E = tbl_docentes.ID_DOCENTE AND NIVEL=2 AND GRADO= 4 AND tbl_grupos.NOMBRE='B'";
                            $sqldoci = "SELECT tbl_docentes.NOMBRE, tbl_docentes.A_PATERNO, tbl_docentes.A_MATERNO FROM `tbl_grupos`,tbl_docentes WHERE tbl_grupos.ID_DOCENTE_I = tbl_docentes.ID_DOCENTE AND NIVEL=2 AND GRADO= 4 AND tbl_grupos.NOMBRE='B'";
                            $resultdoce = mysqli_query($conexion, $sqldoce);
                            $resultdoci = mysqli_query($conexion, $sqldoci);
                            if ($reg = mysqli_fetch_array($resultdoce)) {
                                echo "<th colspan=4><span>Maestro: $reg[0] $reg[1] $reg[2]</span></th>";
                    ...
                    <tbody>
                            <?php 
                            while ($reg = mysqli_fetch_array($result10)) {
                                echo '  <tr>
                                <th scope="row">';
                                echo $reg[0];
                                echo '</th>
            ...
            <div class="tab-pane fade" id="nav-11" role="tabpanel" aria-labelledby="nav-11-tab">
                <table class="table table-striped">
                    ...
                    <tr>
                            <?php 
                            $sqldoce = "SELECT tbl_docentes.NOMBRE, tbl_docentes.A_PATERNO, tbl_docentes.A_MATERNO FROM `tbl_grupos`,tbl_docentes WHERE tbl_grupos.ID_DOCENTE_E = tbl_docentes.ID_DOCENTE AND NIVEL=2 AND GRADO= 5 AND tbl_grupos.NOMBRE='B'";
                            $sqldoci = "SELECT tbl_docentes.NOMBRE, tbl_docentes.A_PATERNO, tbl_docentes.A_MATERNO FROM `tbl_grupos`,tbl_docentes WHERE tbl_grupos.ID_DOCENTE_I = tbl_docentes.ID_DOCENTE AND NIVEL=2 AND GRADO= 5 AND tbl_grupos.NOMBRE='B'";
                            $resultdoce = mysqli_query($conexion, $sqldoce);
                            $resultdoci = mysqli_query($conexion, $sqldoci);
                            if ($reg = mysqli_fetch_array($resultdoce)) {
                                echo "<th colspan=4><span>Maestro: $reg[0] $reg[1] $reg[2]</span></th>";
                    ...
                    <tbody>
                            <?php 
                            while ($reg = mysqli_fetch_array($result11)) {
                                echo '  <tr>
                                <th scope="row">';
                                echo $reg[0];
                                echo '</th>
            ...
            <div class="tab-pane fade" id="nav-12" role="tabpanel" aria-labelledby="nav-12-tab">
                <table class="table table-striped">
                    <thead>
                        <tr>
                            <?php 
                            $sqldoce = "SELECT tbl_docentes.NOMBRE, tbl_docentes.A_PATERNO, tbl_docentes.A_MATERNO FROM `tbl_grupos`,tbl_docentes WHERE tbl_grupos.ID_DOCENTE_E = tbl_docentes.ID_DOCENTE AND NIVEL=2 AND GRADO= 6 AND tbl_grupos.NOMBRE='B'";
                            $sqldoci = "SELECT tbl_docentes.NOMBRE, tbl_docentes.A_PATERNO, tbl_docentes.A_MATERNO FROM `tbl_grupos`,tbl_docentes WHERE tbl_grupos.ID_DOCENTE_I = tbl_docentes.ID_DOCENTE AND NIVEL=2 AND GRADO= 6 AND tbl_grupos.NOMBRE='B'";
                            $resultdoce = mysqli_query($conexion, $sqldoce);
                            $resultdoci = mysqli_query($conexion, $sqldoci);
                            if ($reg = mysqli_fetch_array($resultdoce)) {
                                echo "<th colspan=4><span>Maestro: $reg[0] $reg[1] $reg[2]</span></th>";
                    ...
                    <tbody>
                            <?php 
                            while ($reg = mysqli_fetch_array($result12)) {
                                echo '  <tr>
                                <th scope="row">';
                                echo $reg[0];
                                echo '</th>
